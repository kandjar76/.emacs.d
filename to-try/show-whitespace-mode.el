...
;;  - Add the style concept including the mark style (suggested by P Pareit).
;;  - Add show-whitespace keywords at the end to be compliant with the
;;    outline mode.
;;
;; 2.1  04 Jan 2003  21.2.1
;;  - Show RET in mark mode with ¶.
...
(defcustom show-ws-visible-space 32      ; ?\xBB
  "*Used to show a tab.  It is followed by a tab.
...
(defcustom show-ws-unbr-space 32      ; ?\xBB
  "*Used to show a tab.  It is followed by a tab.

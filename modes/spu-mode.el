...
(setq spu-even-opcodes
      '("nop" "heq" "heqi" "hgt" "hgti" "hlgt" "hlgti" "fa" "fs" "fm" "fma"
...
(setq spu-odd-opcodes
      '("lnop" "br" "brsl" "brhnz" "brhz" "brnz" "brz" "hbrr" "bi" "bisl"
...
(setq spu-fx-opcodes
      '("heq" "heqi" "hgt" "hgti" "hlgt" "hlgti" "ceqb" "ceqbi" "cgtb" "cgtbi"
...
(setq spu-sp-opcodes 
	  '("fa" "fs" "fm" "fma" "fms" "fnma" "fnms" "dfa" "dfs" "dfm" "dfma" "dfms"
		"dfnma" "dfnms"))

(setq spu-bo-opcodes
	  '("cntb" "avgb" "absdb" "sumb"))

(setq spu-ws-opcodes
	  '("shlh" "shlhi" "shl" "shli" "roth" "rothi" "rot" "roti" "rothm" "rothmi"
		"rotm" "rotmi" "rotmah" "rotmahi" "rotma" "rotmai"))

(setq spu-fi-opcodes
	  '("mpy" "mpyi" "mpyu" "mpyui" "mpya" "mpys" "mpyh" "mpyhh" "mpyhhu"
		"mpyhha" "mpyhhau" "fi" "cuflt" "csflt" "cfltu" "cflts" "fesd" "frds"))

(setq spu-br-opcodes
	  '("br" "brsl" "brhnz" "brhz" "brnz" "brz" "hbrr" "bi" "bisl" "bisled"
		"bihnz" "bihz" "binz" "biz" "hbr" "hbrp" "bra" "brasl" "hbra"))

(setq spu-ls-opcodes
	  '("lqa" "lqd" "lqr" "lqx" "stqa" "stqd" "stqr" "stqx"))

(setq spu-sh-opcodes
	  '("shlqby" "shlqbyi" "shlqbybi" "shlqbi" "shlqbii" "rotqby" "rotqbyi"
...
\\{spu-mode-map}"
  ...
  (defconst spu-font-lock-keywords
    (list '("\\.global\\s-+\\(\\(\\sw\\|\\s_\\)+\\)" . 1) ; exported symbol names
	  '("\\_*\\<\\(\\sw\\|\\s_\\)+\\>\\_*:" 0 font-lock-function-name-face) ; labels
	  '("\\(\\s-\\|^\\)\\.\\(\\(\\sw\\|\\s_\\)+\\)" . font-lock-builtin-face) ; preprocessor commands
	  '("\\<nop\\>" 0 spu-nop-opcode-face)
	  '("\\<lnop\\>" 0 spu-lnop-opcode-face)
